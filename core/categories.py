...
categories = {
    ...
    9: [
        'forensics_tools',
        [
            'binwalk', 'bulk-extractor', 'chntpw', 'cuckoo', 'dc3dd', 'ddrescue', 'python3-distorm3', 'dumpzilla',
    ...
    12: [
        'reverse_engineering',
        [
            'apktool', 'dex2jar', 'python3-distorm3', 'edb-debugger', 'jad', 'javasnoop', 'smali', 'valgrind', 'yara'
        ]
    ],
    13: [
        'hardware_hacking',
