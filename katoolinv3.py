...
def main():
 ...
 $$ |$$  /  $$$$$$\  $$$$$$\    $$$$$$\   $$$$$$\  $$ |$$\ $$$$$$$\  
 $$$$$  /   \____$$\ \_$$  _|  $$  __$$\ $$  __$$\ $$ |$$ |$$  __$$\ 
 $$  $$<    $$$$$$$ |  \033[1;36mKali Linux Tools Installer V3.0\033[1;m |$$ |$$ |$$ |  $$ |
 \033[1;36m$$ |\\$$\  $$  __$$ |  $$ |$$\ $$ |  $$ |$$ |  $$ |$$ |$$ |$$ |  $$ |
 $$ | \$$\ \$$$$$$$ |  \$$$$  |\$$$$$$  |\$$$$$$  |$$ |$$ |$$ |  $$ |
 ...
 \033[1;32m+ -- -- +=[ Modified by: Bishesh Dulal | GitHub: https://github.com/bisesdulal16\033[1;m
 \033[1;32m+ -- -- +=[ 331 Tools \033[1;m

 \033[1;92m+ -- -- +=[ Trademark: Bishesh Dulal\033[1;m
...
0) Install all Vulnerability Analysis tools
                            ...
                            if opcion2 == "1":
                                ...
                                cmd = os.system("apt-get install git && git clone https://github.com/stasinopoulos/commix.git commix && cd commix && python3 ./commix.py --install")
                            elif opcion2 == "9":
...
0) Install all Wireless Attacks tools
                        ...
                        ''')
                            ...
                            if opcion2 == "1":
                                ...
                                cmd = os.system("apt-get install gr-scan")
                            elif opcion2 == "17":
